...
const App: React.FC = () => {
  const hoje = historicoDados;

  const [searchTerm, setSearchTerm] = useState('');
  const [currentPage, setCurrentPage] = useState(1);
  const itemsPerPage = 15;

  // Filtra os dados de acordo com o que for digitado na busca
  ...
  const handleSearch = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setCurrentPage(1); // Volta pra primeira página ao pesquisar algo novo
  };

  // 🚀 Lógica do Botão Exportar (Gera o CSV para o Excel)
  const exportToExcel = () => {
    ...
    filteredData.forEach((item: any) => {
      ...
      // As aspas garantem que o Excel não quebre as colunas se houver vírgulas no texto
  ...
  return (
    <div className="dashboard-container">
      ...
      <main className="main-content">
        ...
        {/* ==========================================
            ÁREA DA TABELA DE INVESTIGAÇÃO
            ========================================== */}
